// =================== بيانات الطالب =================== const studentData = { "1121094377": { name: "أملاك فواز غربي الشمري", degree: "بكالوريوس", major: "قانون تجاري", status: "مقبول", admissionDate: "2025/09/01", phone: "0501733515", fees: { tuition: 1500, registration: 0, books: 0, total: 1500 } } };

let currentStudent = null;

// =================== دوال مساعدة =================== function hideAllForms() { ["forms-section", "results-section", "inquiry-form"].forEach(id => document.getElementById(id)?.classList.add("hidden")); }

function scrollToElement(id) { document.getElementById(id)?.scrollIntoView({ behavior: "smooth", block: "start" }); }

// =================== إظهار نموذج الاستعلام =================== function showInquiryForm() { hideAllForms(); document.getElementById("forms-section")?.classList.remove("hidden"); document.getElementById("inquiry-form")?.classList.remove("hidden"); document.getElementById("inquiry-id").value = ""; document.getElementById("inquiry-phone").value = ""; scrollToElement("forms-section"); }

// =================== فحص بيانات القبول =================== function checkAdmission() { const id = document.getElementById("inquiry-id").value.trim(); const phone = document.getElementById("inquiry-phone").value.trim();
...
// =================== عرض نتيجة القبول =================== function showAdmissionResult() { hideAllForms(); const resultsSection = document.getElementById("results-section");
...
// =================== شاشة تأكيد القبول =================== function showConfirmationSuccess() { hideAllForms(); const resultsSection = document.getElementById("results-section");
...
// =================== شاشة السداد =================== function showPaymentInvoice() { hideAllForms(); const resultsSection = document.getElementById("results-section");
    ...
    <div class="result-card">
        ...
        <div class="bank-info">
            ...
            <div class="bank-details">
                ...
                <div class="bank-item"><span>اسم المستفيد:</span><span>—</span></div>
            </div>
        </div>
        ...
        <div class="upload-section">
            ...
            <div class="transaction-details">
                ...
                <div class="transaction-item">
                    ...
                    <input type="text" id="transaction-number">
                </div>
                <div class="transaction-item">
...
// =================== عرض اسم الملف =================== function displayFileName() { const file = document.getElementById("receipt-upload").files[0]; document.getElementById("file-name").textContent = file ? file.name : ""; }

// =================== إرسال الإيصال =================== function submitPayment() { alert("تم إرسال الإيصال بنجاح وسيتم مراجعته"); }

// =================== تهيئة الصفحة =================== document.addEventListener("DOMContentLoaded", () => { hideAllForms(); showInquiryForm(); });
